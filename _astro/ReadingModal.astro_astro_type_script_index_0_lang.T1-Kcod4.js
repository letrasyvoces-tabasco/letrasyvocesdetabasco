const e=document.getElementById("reading-modal"),r=document.getElementById("close-reading-modal"),i=document.getElementById("reader-content-box"),s=document.getElementById("modal-book-title"),d=document.getElementById("modal-book-author"),t=document.getElementById("modal-book-text"),c=document.getElementById("modal-wa-btn"),y={animalia:{title:"Animalia Literaria",author:"Antología Colectiva · 16 Escritores · 131 Páginas",waText:"Hola Mesa Directiva de LVT, leí la muestra de Animalia Literaria y deseo información sobre su adquisición y preventa.",contentHtml:`
        <p class="italic text-center mb-6 font-serif">
        ...
        <div class="my-6 p-4 rounded-xl reader-quote-box border-l-4 italic text-sm">
      ...
      `}};window.openReadingSample=function(o){const n=y[o];!n||!e||!s||!d||!t||!c||(s.innerText=n.title,d.innerText=n.author,t.innerHTML=n.contentHtml,c.setAttribute("href",`https://wa.me/529932647502?text=${encodeURIComponent(n.waText)}`),e.classList.remove("hidden"),document.body.style.overflow="hidden")};function g(){e&&(e.classList.add("hidden"),document.body.style.overflow="")}r&&r.addEventListener("click",g);e&&e.addEventListener("click",o=>{o.target===e&&g()});let a=18;const m=document.getElementById("font-increase"),u=document.getElementById("font-decrease");m&&t&&m.addEventListener("click",()=>{a<26&&(a+=2,t.style.fontSize=`${a}px`)});u&&t&&u.addEventListener("click",()=>{a>14&&(a-=2,t.style.fontSize=`${a}px`)});const f=document.getElementById("theme-pergamino"),p=document.getElementById("theme-marfil"),b=document.getElementById("theme-noche");function l(o){i&&(i.className=`p-8 sm:p-12 overflow-y-auto flex-1 transition-colors duration-200 ${o}`)}f&&f.addEventListener("click",()=>l("reader-pergamino"));p&&p.addEventListener("click",()=>l("reader-marfil"));b&&b.addEventListener("click",()=>l("reader-noche"));
