// src/data/voces.ts - Catálogo Oficial de 14 Grabaciones Sonoras en Audio Nativo MP3 (Audioteca LVT)
...
export interface GrabacionSonora {
  ...
  audioUrl: string; // Todas las 14 pistas cuentan con audio nativo MP3
  descripcion: string;
  textoPoema: string;
}
...
export const CATALOGO_VOCES_HISTORICAS: GrabacionSonora[] = [
  {
    ...
    descripcion: 'Grabación oficial de estudio en alta fidelidad preservada en el archivo sonoro de la Sociedad de Escritores Letras y Voces de Tabasco, A.C.',
  ...
  },
  {
    ...
    audioUrl: '/letrasyvocesdetabasco/assets/audios/rulfo_hidrante.mp3',
  ...
  },
  {
    ...
    tipo: 'archivo_historico',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/mutis_palabra.mp3',
  ...
  },
  {
    ...
    pais: 'La Habana, Cuba',
    tipo: 'archivo_historico',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/retamar_felices.mp3',
  ...
  },
  {
    ...
    pais: 'Chiapas, México',
    tipo: 'archivo_historico',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/sabines_despues.mp3',
  ...
  },
  {
    ...
    tipo: 'archivo_historico',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/neruda_fabula.mp3',
  ...
  },
  {
    ...
    pais: 'Chiapas, México',
    tipo: 'archivo_historico',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/sabines_cuerpo.mp3',
  ...
  },
  {
    ...
    tipo: 'archivo_historico',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/dario_gelman_metempsicosis.mp3',
  ...
  },
  {
    ...
    pais: 'Nicaragua / Argentina',
    tipo: 'archivo_historico',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/dario_gelman_fatal.mp3',
  ...
  },
  {
    ...
    pais: 'Chile / México',
    tipo: 'archivo_historico',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/neruda_sabines_manos.mp3',
  ...
  },
  {
    ...
    tipo: 'archivo_historico',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/cortazar_angeles.mp3',
  ...
  },
  {
    ...
    pais: 'Lima, Perú',
    tipo: 'archivo_historico',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/varela_escucharas.mp3',
  ...
  },
  {
    ...
    tipo: 'archivo_historico',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/roby_boston.mp3',
