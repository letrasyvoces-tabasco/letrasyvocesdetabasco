// src/data/voces.ts - Catálogo Oficial de 14 Grabaciones Sonoras de la Audioteca LVT
...
export interface GrabacionSonora {
  ...
  audioUrl?: string; // Para audios nativos MP3
  youtubeId?: string; // Para grabaciones de archivo
  youtubeUrl?: string;
  descripcion: string;
  textoPoema: string;
}
...
export const CATALOGO_VOCES_HISTORICAS: GrabacionSonora[] = [
  ...
  },
  {
    ...
    youtubeUrl: 'https://youtu.be/A8PMbJBfn60?list=PLkBildazp7OBfnh4eahKj91MQXiaumTer',
  ...
  },
  {
    ...
    tipo: 'estudio_local',
    audioUrl: '/letrasyvocesdetabasco/assets/audios/lorca_alberti_balada.mp3',
    youtubeId: '2g5htFWI93M',
    youtubeUrl: 'https://youtu.be/2g5htFWI93M?list=PLkBildazp7OBfnh4eahKj91MQXiaumTer',
  ...
  },
  {
    ...
    youtubeUrl: 'https://www.youtube.com/watch?v=HeRZdX6dlFM&list=PLkBildazp7OBfnh4eahKj91MQXiaumTer&index=2',
  ...
  },
  {
    ...
    youtubeUrl: 'https://youtu.be/oZZkFZIHvS0?list=PLkBildazp7OBfnh4eahKj91MQXiaumTer',
  ...
  },
  {
    ...
    youtubeUrl: 'https://youtu.be/Xr1ZAO6dCKo?list=PLkBildazp7OBfnh4eahKj91MQXiaumTer',
  ...
  },
  {
    ...
    youtubeUrl: 'https://youtu.be/k58RbmbR8ts',
  ...
  },
  {
    ...
    youtubeUrl: 'https://youtu.be/F3xOMkL3SlQ?list=PLkBildazp7OBfnh4eahKj91MQXiaumTer',
  ...
  },
  {
    ...
    youtubeUrl: 'https://youtu.be/71iE-TRMf1k?list=PLkBildazp7OBfnh4eahKj91MQXiaumTer',
  ...
  },
  {
    ...
    youtubeUrl: 'https://youtu.be/DpT2_s3bBkQ?list=PLkBildazp7OBfnh4eahKj91MQXiaumTer',
  ...
  },
  {
    ...
    youtubeUrl: 'https://youtu.be/IjamPDrZSGs?list=PLkBildazp7OBfnh4eahKj91MQXiaumTer',
  ...
  },
  {
    ...
    youtubeUrl: 'https://youtu.be/qlHGoqv7X90?list=PLkBildazp7OBfnh4eahKj91MQXiaumTer',
  ...
  },
  {
    ...
    youtubeUrl: 'https://youtu.be/56urWZP4sR8?list=PLkBildazp7OBfnh4eahKj91MQXiaumTer',
  ...
  },
  {
    ...
    youtubeUrl: 'https://youtu.be/cfo9pieXtP4?list=PLkBildazp7OBfnh4eahKj91MQXiaumTer',
